...
const resources = {
  en: {
    ...
    auth: {
      ...
      or: "or",
      welcomeBack: "Welcome to Tenezis",
      loginToAccess: "Login to access public spaces and collaborate",
      success: "Success!",
      error: "Error",
    ...
    spaces: {
      ...
      createFirst: "Create your first space to get started",
  ...
  "join": {
    ...
    "loginToJoin": "Vous devez vous connecter pour rejoindre cet espace.",
    "loading": "Chargement des informations de l'espace...",
    "invalidInvite": "Invitation Invalide",
    "expiredOrInvalid": "Ce lien d'invitation a expiré ou n'est pas valide.",
    "browsePublic": "Parcourir les Espaces Publics",
    "joinedSuccess": "Rejoint avec Succès!",
    "redirectingToSpace": "Redirection vers l'espace...",
    ...
    "redirecting": "Redirection vers l'espace...",
    "success": "Bienvenue!",
    "welcomeToSpace": "Bienvenue dans {{spaceName}}!",
    "error": "Erreur",
    ...
    chat: {
      placeholder: "Ask me anything about the documents in this space...",
      send: "Send",
      ...
      welcome: "Welcome to",
      startConversation: "Ask questions about documents in this space or chat with other members.",
      recentConversations: "Recent conversations",
      chatHistory: "No recent conversations yet. Start by asking a question!",
      documents: "Documents",
      members: "Members",
      team: "Team",
      settings: "Settings",
      ...
      aiAnalyzed: "The AI analyzed your documents and provided a response",
      ...
      documentReferenced: "Referenced document",
      backToSpaces: "Back to spaces",
      ...
      teamMessageSent: "Your team message has been sent",
    },
    discover: {
      explorePublic: "Explore Public Spaces",
      joinSpaces: "Join Collaboration Spaces",
      description: "Discover AI-powered collaborative workspaces for research, analysis, and knowledge sharing",
      searchPlaceholder: "Search spaces by name, category, or tags...",
      all: "All",
  ...
  fr: {
    translation: {
      ...
      "chat.teamMessageSent": "Votre message d'équipe a été envoyé",

      // Discover
      "discover.explorePublic": "Explorer les Espaces Publics",
      "discover.joinSpaces": "Rejoignez des Espaces de Collaboration",
      "discover.description": "Découvrez des espaces de travail collaboratifs alimentés par l'IA pour la recherche, l'analyse et le partage de connaissances",
      "discover.searchPlaceholder": "Rechercher des spaces par nom, catégorie, ou tags...",
      "discover.all": "Tous",
      "discover.spacesAvailable": "espaces disponibles",
      "discover.noSpaces": "Aucun espace trouvé",
      "discover.tryAdjusting": "Essayez d'ajuster vos filtres ou votre recherche",
      "discover.joinSpace": "Rejoindre le Space",
