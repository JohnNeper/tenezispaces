...
const resources = {
  ...
  "join": {
    ...
    chat: {
      placeholder: "Posez-moi des questions sur les documents de cet espace...",
      send: "Envoyer",
      ...
      startConversation: "Posez des questions sur les documents dans cet espace ou discutez avec les autres membres.",
      recentConversations: "Conversations récentes",
      chatHistory: "Pas encore de conversations récentes. Commencez en posant une question!",
      documents: "Documents",
      members: "Membres",
      team: "Équipe",
      settings: "Paramètres",
      ...
      aiAnalyzed: "L'IA a analysé vos documents et fourni une réponse",
      ...
      documentReferenced: "Document référencé",
